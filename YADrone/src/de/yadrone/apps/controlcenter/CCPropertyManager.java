...
public class CCPropertyManager extends Properties
{
	...
	public boolean isControllerGameCommandManager() {
		return Boolean.parseBoolean(getProperty("controller_game_command_layout","false"));
	}
	public void setControllerGameCommandManager(boolean isControllerGame) {
